package com.mayb.bookhub.activity
        ...
        if(ConnectionManager().checkConnectivity(this@DescriptionActivity)){
            val jsonRequest = object: JsonObjectRequest(Request.Method.POST,url,jsonParams,Response.Listener{
                ...
                try{
                    ...
                    if(success){
                        ...
                        btnAddToFav.setOnClickListener {
                            if(!DBAsyncTask(applicationContext,bookEntity,1).execute().get()){
                                // handle case when book not favourite
                                ...
                                val result = async.get()
                                if(result){
                                    Toast.makeText(this@DescriptionActivity,"remove from favourite",Toast.LENGTH_SHORT).show()
                                    btnAddToFav.text = "Add to favourites"
                                    val noFavColor = ContextCompat.getColor(applicationContext,R.color.colorPrimary)
                                    btnAddToFav.setBackgroundColor(noFavColor)
                                }else{
                        ...
                        Toast.makeText(this@DescriptionActivity,"Error api success not found ",Toast.LENGTH_SHORT).show()
                    }
                    ...
                    Toast.makeText(this@DescriptionActivity,"json error occured: Description",Toast.LENGTH_SHORT).show()
                }
